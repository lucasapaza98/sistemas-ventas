...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="<?php echo $URL; ?>/lector.php" class="nav-link">SISTEMAS DE VENTAS</a>
            </li>
            <!-- NAVBAR INDEX -->
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo $URL; ?>/privilegios/usuarios_privilegios.php" class="dropdown-item">Listado de usuarios </a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo $URL; ?>/privilegios/roles_privilegios.php" class="dropdown-item">Listado de roles </a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo $URL; ?>/categorias/" class="dropdown-item">Listado de categorías </a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo $URL; ?>/almacen/" class="dropdown-item">Listado de producto </a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                ...
                <li><a href="<?php echo $URL; ?>/ventas/create.php" class="dropdown-item">Realizar una venta</a></li>
            ...
            <li class="nav-item dropdown dropdown-hover">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo $URL; ?>/clientes/" class="dropdown-item">Listado de clientes </a></li>
              </ul>
            </li>
          </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <!-- Brand Logo -->
      <a href="<?php echo $URL; ?>/lector.php/" class="brand-link">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo $URL; ?>/privilegios/usuarios_privilegios.php" class="nav-link">
            ...
            <li class="nav-item ">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo $URL; ?>/privilegios/roles_privilegios.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>

...
//echo "id_compra=".$id_compra." id_producto= ".$id_producto." cantidad_compra= ".$cantidad_compra." stock_actual: ".$stock_actual;
...
if($sentencia->execute()){
    ...
    session_start();
    $_SESSION['mensaje'] = "Error no se pudo borrar la compra en la base de datos";

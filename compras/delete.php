                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="text" id="id_producto" value="<?=$id_producto_update;?>" hidden>
                            ...
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button class="btn btn-danger btn-block" id="btn_eliminar"><i class="fas fa-trash"></i>Eliminar</button>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div id="respuesta_compra_delete"></div>

                                        <script>
                                            $("#btn_eliminar").click(function() {
                                                var id_compra = '<?php echo $id_compra_get; ?>';
                                                var id_producto = $('#id_producto').val();
                                                var cantidad_compra= '<?= $cantidad_compra_producto;?>';
                                                var stock_actual = <?php echo $stock2; ?>;
                                                ...
                                                function eliminar() {
                                                    var url4 = "../app/controllers/compras/delete.php";
                                                    $.get(url4, {
                                                        id_compra: id_compra,
                                                        ...
                                                        $('#respuesta_compra_delete').html(datos);
                                                    });
                                                }
                                            });
                                        </script>
